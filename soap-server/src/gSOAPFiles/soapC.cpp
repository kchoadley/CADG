...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.75 2019-03-13 02:21:14 GMT")
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info_area_geocode(struct soap *soap, const char *tag, int id, const _ns4__alert_info_area_geocode *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info_area_geocode), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:valueName", -1, &a->_ns4__alert_info_area_geocode::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:value", -1, &a->_ns4__alert_info_area_geocode::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info_area(struct soap *soap, const char *tag, int id, const _ns4__alert_info_area *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info_area), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:areaDesc", -1, &a->_ns4__alert_info_area::areaDesc, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns4:polygon", -1, &a->_ns4__alert_info_area::polygon, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns4:circle", -1, &a->_ns4__alert_info_area::circle, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns4__alert_info_area_geocode(soap, "ns4:geocode", -1, &a->_ns4__alert_info_area::geocode, ""))
		return soap->error;
	if (soap_out_PointerToxsd__decimal(soap, "ns4:altitude", -1, &a->_ns4__alert_info_area::altitude, ""))
		return soap->error;
	if (soap_out_PointerToxsd__decimal(soap, "ns4:ceiling", -1, &a->_ns4__alert_info_area::ceiling, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info_resource(struct soap *soap, const char *tag, int id, const _ns4__alert_info_resource *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info_resource), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:resourceDesc", -1, &a->_ns4__alert_info_resource::resourceDesc, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:mimeType", -1, &a->_ns4__alert_info_resource::mimeType, ""))
		return soap->error;
	if (soap_out_PointerToxsd__integer(soap, "ns4:size", -1, &a->_ns4__alert_info_resource::size, ""))
		return soap->error;
	if (soap_out_PointerToxsd__anyURI(soap, "ns4:uri", -1, &a->_ns4__alert_info_resource::uri, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:derefUri", -1, &a->_ns4__alert_info_resource::derefUri, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:digest", -1, &a->_ns4__alert_info_resource::digest, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info_parameter(struct soap *soap, const char *tag, int id, const _ns4__alert_info_parameter *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info_parameter), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:valueName", -1, &a->_ns4__alert_info_parameter::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:value", -1, &a->_ns4__alert_info_parameter::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info_eventCode(struct soap *soap, const char *tag, int id, const _ns4__alert_info_eventCode *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info_eventCode), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:valueName", -1, &a->_ns4__alert_info_eventCode::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:value", -1, &a->_ns4__alert_info_eventCode::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert_info(struct soap *soap, const char *tag, int id, const _ns4__alert_info *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert_info), type))
		return soap->error;
	if (soap_out_PointerToxsd__language(soap, "ns4:language", -1, &a->_ns4__alert_info::language, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns4__alert_info_category(soap, "ns4:category", -1, &a->_ns4__alert_info::category, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:event", -1, &a->_ns4__alert_info::event, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns4__alert_info_responseType(soap, "ns4:responseType", -1, &a->_ns4__alert_info::responseType, ""))
		return soap->error;
	if (soap_out__ns4__alert_info_urgency(soap, "ns4:urgency", -1, &a->_ns4__alert_info::urgency, ""))
		return soap->error;
	if (soap_out__ns4__alert_info_severity(soap, "ns4:severity", -1, &a->_ns4__alert_info::severity, ""))
		return soap->error;
	if (soap_out__ns4__alert_info_certainty(soap, "ns4:certainty", -1, &a->_ns4__alert_info::certainty, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:audience", -1, &a->_ns4__alert_info::audience, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns4__alert_info_eventCode(soap, "ns4:eventCode", -1, &a->_ns4__alert_info::eventCode, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns4:effective", -1, &a->_ns4__alert_info::effective, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns4:onset", -1, &a->_ns4__alert_info::onset, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns4:expires", -1, &a->_ns4__alert_info::expires, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:senderName", -1, &a->_ns4__alert_info::senderName, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:headline", -1, &a->_ns4__alert_info::headline, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:description", -1, &a->_ns4__alert_info::description, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:instruction", -1, &a->_ns4__alert_info::instruction, ""))
		return soap->error;
	if (soap_out_PointerToxsd__anyURI(soap, "ns4:web", -1, &a->_ns4__alert_info::web, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:contact", -1, &a->_ns4__alert_info::contact, ""))
		return soap->error;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__alert(struct soap *soap, const char *tag, int id, const _ns4__alert *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__alert), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:identifier", -1, &a->_ns4__alert::identifier, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns4:sender", -1, &a->_ns4__alert::sender, ""))
		return soap->error;
	if (soap_out_dateTime(soap, "ns4:sent", -1, &a->_ns4__alert::sent, ""))
		return soap->error;
	if (soap_out__ns4__alert_status(soap, "ns4:status", -1, &a->_ns4__alert::status, ""))
		return soap->error;
	if (soap_out__ns4__alert_msgType(soap, "ns4:msgType", -1, &a->_ns4__alert::msgType, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:source", -1, &a->_ns4__alert::source, ""))
		return soap->error;
	if (soap_out__ns4__alert_scope(soap, "ns4:scope", -1, &a->_ns4__alert::scope, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:restriction", -1, &a->_ns4__alert::restriction, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:addresses", -1, &a->_ns4__alert::addresses, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns4:code", -1, &a->_ns4__alert::code, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:note", -1, &a->_ns4__alert::note, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:references", -1, &a->_ns4__alert::references, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:incidents", -1, &a->_ns4__alert::incidents, ""))
		return soap->error;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOf_ns4__alert_info_responseType(struct soap *soap, const char *tag, int id, const std::vector<enum _ns4__alert_info_responseType> *a, const char *type)
{
	...
	{
		if (soap_out__ns4__alert_info_responseType(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOf_ns4__alert_info_category(struct soap *soap, const char *tag, int id, const std::vector<enum _ns4__alert_info_category> *a, const char *type)
{
	...
	{
		if (soap_out__ns4__alert_info_category(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
