...
# GSOAP_LIBRARIES       = /usr/lib/x86_64-linux-gnu/
...
message(Starting GSOAP_C_LIBRARIES)
...
message(Starting GSOAP_SSL_C_LIBRARIES)
...
# -----------------------------------------------------
message(Starting GSOAP_INCLUDE_DIR)
...
# GSOAP Binaries
# ----------------------------------------------------
message(Starting NOT GSOAP_TOOL_DIR)
if(NOT GSOAP_TOOL_DIR)
    set(GSOAP_TOOL_DIR GSOAP_ROOT)
endif()

message(Starting GSOAP_WSDL2H)
...
message(Starting GSOAP_SOAPCPP2)
