...
/* CAP-v1.2.h
   Generated by wsdl2h 2.8.28 from CAP-v1.2.xsd and typemap.dat
   2018-11-27 03:29:03 GMT
...
@note HINTS:
 - Run soapcpp2 on CAP-v1.2.h to generate the SOAP/XML processing logic.
...
/// - _ns1__alert* soap_new__ns1__alert(soap*) allocate
/// - _ns1__alert* soap_new__ns1__alert(soap*, int num) allocate array
...
/// - _ns1__alert::soap_default(soap*) reset members to default
...
/// Content pattern is "\\d\\d\\d\\d-\\d\\d-\\d\\dT\\d\\d:\\d\\d:\\d\\d[-,+]\\d\\d:\\d\\d".
    ...
    {
	_ns1__alert_status__Actual,	///< xs:string value="Actual"
	_ns1__alert_status__Exercise,	///< xs:string value="Exercise"
	_ns1__alert_status__System,	///< xs:string value="System"
	_ns1__alert_status__Test,	///< xs:string value="Test"
	_ns1__alert_status__Draft,	///< xs:string value="Draft"
    }
                                         status                         1;	///< Required element.
    enum _ns1__alert_msgType
    {
	_ns1__alert_msgType__Alert,	///< xs:string value="Alert"
	_ns1__alert_msgType__Update,	///< xs:string value="Update"
	_ns1__alert_msgType__Cancel,	///< xs:string value="Cancel"
	_ns1__alert_msgType__Ack,	///< xs:string value="Ack"
	_ns1__alert_msgType__Error,	///< xs:string value="Error"
    }
...
/// Element "source" of XSD type xs:string.
    ...
    {
	_ns1__alert_scope__Public,	///< xs:string value="Public"
	_ns1__alert_scope__Restricted,	///< xs:string value="Restricted"
	_ns1__alert_scope__Private,	///< xs:string value="Private"
    }
...
/// - _ns1__alert_info* soap_new__ns1__alert_info(soap*) allocate
/// - _ns1__alert_info* soap_new__ns1__alert_info(soap*, int num) allocate array
...
/// - _ns1__alert_info::soap_default(soap*) reset members to default
...
/// Element "language" of XSD type xs:language.
    xsd__language                        language                       0;	///< Default element value="en-US".
/// Vector of category of length 1..unbounded.
    std::vector<
    enum _ns1__alert_info_category
    {
	_ns1__alert_info_category__Geo,	///< xs:string value="Geo"
	_ns1__alert_info_category__Met,	///< xs:string value="Met"
	_ns1__alert_info_category__Safety,	///< xs:string value="Safety"
	_ns1__alert_info_category__Security,	///< xs:string value="Security"
	_ns1__alert_info_category__Rescue,	///< xs:string value="Rescue"
	_ns1__alert_info_category__Fire,	///< xs:string value="Fire"
	_ns1__alert_info_category__Health,	///< xs:string value="Health"
	_ns1__alert_info_category__Env,	///< xs:string value="Env"
	_ns1__alert_info_category__Transport,	///< xs:string value="Transport"
	_ns1__alert_info_category__Infra,	///< xs:string value="Infra"
	_ns1__alert_info_category__CBRNE,	///< xs:string value="CBRNE"
	_ns1__alert_info_category__Other,	///< xs:string value="Other"
    }
    >                                    category                       1;
...
/// Vector of responseType of length 0..unbounded.
    ...
    {
	_ns1__alert_info_responseType__Shelter,	///< xs:string value="Shelter"
	_ns1__alert_info_responseType__Evacuate,	///< xs:string value="Evacuate"
	_ns1__alert_info_responseType__Prepare,	///< xs:string value="Prepare"
	_ns1__alert_info_responseType__Execute,	///< xs:string value="Execute"
	_ns1__alert_info_responseType__Avoid,	///< xs:string value="Avoid"
	_ns1__alert_info_responseType__Monitor,	///< xs:string value="Monitor"
	_ns1__alert_info_responseType__Assess,	///< xs:string value="Assess"
	_ns1__alert_info_responseType__AllClear,	///< xs:string value="AllClear"
	_ns1__alert_info_responseType__None,	///< xs:string value="None"
    }
    >                                   *responseType                   0;
    enum _ns1__alert_info_urgency
    {
	_ns1__alert_info_urgency__Immediate,	///< xs:string value="Immediate"
	_ns1__alert_info_urgency__Expected,	///< xs:string value="Expected"
	_ns1__alert_info_urgency__Future,	///< xs:string value="Future"
	_ns1__alert_info_urgency__Past,	///< xs:string value="Past"
	_ns1__alert_info_urgency__Unknown,	///< xs:string value="Unknown"
    }
                                         urgency                        1;	///< Required element.
    enum _ns1__alert_info_severity
    {
	_ns1__alert_info_severity__Extreme,	///< xs:string value="Extreme"
	_ns1__alert_info_severity__Severe,	///< xs:string value="Severe"
	_ns1__alert_info_severity__Moderate,	///< xs:string value="Moderate"
	_ns1__alert_info_severity__Minor,	///< xs:string value="Minor"
	_ns1__alert_info_severity__Unknown,	///< xs:string value="Unknown"
    }
                                         severity                       1;	///< Required element.
    enum _ns1__alert_info_certainty
    {
	_ns1__alert_info_certainty__Observed,	///< xs:string value="Observed"
	_ns1__alert_info_certainty__Likely,	///< xs:string value="Likely"
	_ns1__alert_info_certainty__Possible,	///< xs:string value="Possible"
	_ns1__alert_info_certainty__Unlikely,	///< xs:string value="Unlikely"
	_ns1__alert_info_certainty__Unknown,	///< xs:string value="Unknown"
    }
...
/// - _ns1__alert_info_eventCode* soap_new__ns1__alert_info_eventCode(soap*) allocate
/// - _ns1__alert_info_eventCode* soap_new__ns1__alert_info_eventCode(soap*, int num) allocate array
...
/// - _ns1__alert_info_eventCode::soap_default(soap*) reset members to default
...
/// - _ns1__alert_info_parameter* soap_new__ns1__alert_info_parameter(soap*) allocate
/// - _ns1__alert_info_parameter* soap_new__ns1__alert_info_parameter(soap*, int num) allocate array
...
/// - _ns1__alert_info_parameter::soap_default(soap*) reset members to default
...
/// - _ns1__alert_info_resource* soap_new__ns1__alert_info_resource(soap*) allocate
/// - _ns1__alert_info_resource* soap_new__ns1__alert_info_resource(soap*, int num) allocate array
...
/// - _ns1__alert_info_resource::soap_default(soap*) reset members to default
...
/// - _ns1__alert_info_area* soap_new__ns1__alert_info_area(soap*) allocate
/// - _ns1__alert_info_area* soap_new__ns1__alert_info_area(soap*, int num) allocate array
...
/// - _ns1__alert_info_area::soap_default(soap*) reset members to default
...
/// Vector of std::string of length 0..unbounded.
    std::vector<std::string            > polygon                        0;
/// Vector of std::string of length 0..unbounded.
    std::vector<std::string            > circle                         0;
/// Vector of geocode of length 0..unbounded.
    std::vector<
/// class _ns1__alert_info_area_geocode operations:
/// - _ns1__alert_info_area_geocode* soap_new__ns1__alert_info_area_geocode(soap*) allocate
/// - _ns1__alert_info_area_geocode* soap_new__ns1__alert_info_area_geocode(soap*, int num) allocate array
...
/// - _ns1__alert_info_area_geocode::soap_default(soap*) reset members to default
