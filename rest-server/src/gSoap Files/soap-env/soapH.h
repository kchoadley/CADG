...
#define soap_default_ns1__encodingStyle(soap, a) soap_default_std__string(soap, a)

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__encodingStyle(struct soap*, const std::string *);

#define soap_ns1__encodingStyle2s soap_std__string2s

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__encodingStyle(struct soap*, const char*, int, const std::string*, const char*);

#define soap_s2ns1__encodingStyle soap_s2std__string

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_in_ns1__encodingStyle(struct soap*, const char*, std::string*, const char*);

#define soap_instantiate_ns1__encodingStyle soap_instantiate_std__string


#define soap_new_ns1__encodingStyle soap_new_std__string

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__encodingStyle(struct soap*, const std::string *, const char*, const char*);

#ifndef soap_write_ns1__encodingStyle
#define soap_write_ns1__encodingStyle(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns1__encodingStyle(soap, data), 0) || soap_put_ns1__encodingStyle(soap, data, "ns1:encodingStyle", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_get_ns1__encodingStyle(struct soap*, std::string *, const char*, const char*);

#ifndef soap_read_ns1__encodingStyle
#define soap_read_ns1__encodingStyle(soap, data) ( ((data) ? (soap_default_ns1__encodingStyle(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__encodingStyle(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#endif
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__detail(struct soap*, const char*, int, const ns1__detail *, const char*);
SOAP_FMAC3 ns1__detail * SOAP_FMAC4 soap_in_ns1__detail(struct soap*, const char*, ns1__detail *, const char*);
SOAP_FMAC1 ns1__detail * SOAP_FMAC2 soap_instantiate_ns1__detail(struct soap*, int, const char*, const char*, size_t*);

inline ns1__detail * soap_new_ns1__detail(struct soap *soap, int n = -1) { return soap_instantiate_ns1__detail(soap, n, NULL, NULL, NULL); }

inline ns1__detail * soap_new_req_ns1__detail(
	struct soap *soap)
{	ns1__detail *_p = soap_new_ns1__detail(soap);
	if (_p)
...
inline ns1__detail * soap_new_set_ns1__detail(
	struct soap *soap,
...
{	ns1__detail *_p = soap_new_ns1__detail(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__detail::__any = __any;
		_p->ns1__detail::__anyAttribute = __anyAttribute;
	}
	return _p;
}

#ifndef soap_write_ns1__detail
#define soap_write_ns1__detail(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns1:detail", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 ns1__detail * SOAP_FMAC4 soap_get_ns1__detail(struct soap*, ns1__detail *, const char*, const char*);

#ifndef soap_read_ns1__detail
#define soap_read_ns1__detail(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__detail(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#endif
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__Fault(struct soap*, const char*, int, const ns1__Fault *, const char*);
SOAP_FMAC3 ns1__Fault * SOAP_FMAC4 soap_in_ns1__Fault(struct soap*, const char*, ns1__Fault *, const char*);
SOAP_FMAC1 ns1__Fault * SOAP_FMAC2 soap_instantiate_ns1__Fault(struct soap*, int, const char*, const char*, size_t*);

inline ns1__Fault * soap_new_ns1__Fault(struct soap *soap, int n = -1) { return soap_instantiate_ns1__Fault(soap, n, NULL, NULL, NULL); }

inline ns1__Fault * soap_new_req_ns1__Fault(
	struct soap *soap,
	const std::string& faultcode,
	const std::string& faultstring)
{	ns1__Fault *_p = soap_new_ns1__Fault(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__Fault::faultcode = faultcode;
		_p->ns1__Fault::faultstring = faultstring;
	}
	return _p;
}

inline ns1__Fault * soap_new_set_ns1__Fault(
	struct soap *soap,
	const std::string& faultcode,
	const std::string& faultstring,
...
{	ns1__Fault *_p = soap_new_ns1__Fault(soap);
	...
	{	_p->soap_default(soap);
		_p->ns1__Fault::faultcode = faultcode;
		_p->ns1__Fault::faultstring = faultstring;
		_p->ns1__Fault::faultactor = faultactor;
		_p->ns1__Fault::detail = detail;
	}
	return _p;
}

#ifndef soap_write_ns1__Fault
#define soap_write_ns1__Fault(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns1:Fault", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 ns1__Fault * SOAP_FMAC4 soap_get_ns1__Fault(struct soap*, ns1__Fault *, const char*, const char*);

#ifndef soap_read_ns1__Fault
#define soap_read_ns1__Fault(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__Fault(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
inline ns1__Body * soap_new_req_ns1__Body(
	struct soap *soap)
{	ns1__Body *_p = soap_new_ns1__Body(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline ns1__Body * soap_new_set_ns1__Body(
	struct soap *soap,
	const std::vector<char *> & __any,
	char *__anyAttribute)
{	ns1__Body *_p = soap_new_ns1__Body(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__Body::__any = __any;
		_p->ns1__Body::__anyAttribute = __anyAttribute;
	}
	return _p;
}
...
#define soap_read_ns1__Body(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__Body(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
inline ns1__Header * soap_new_req_ns1__Header(
	struct soap *soap)
{	ns1__Header *_p = soap_new_ns1__Header(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline ns1__Header * soap_new_set_ns1__Header(
	struct soap *soap,
	const std::vector<char *> & __any,
	char *__anyAttribute)
{	ns1__Header *_p = soap_new_ns1__Header(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__Header::__any = __any;
		_p->ns1__Header::__anyAttribute = __anyAttribute;
	}
	return _p;
}
...
#define soap_read_ns1__Header(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__Header(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#endif
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__Envelope(struct soap*, const char*, int, const ns1__Envelope *, const char*);
SOAP_FMAC3 ns1__Envelope * SOAP_FMAC4 soap_in_ns1__Envelope(struct soap*, const char*, ns1__Envelope *, const char*);
SOAP_FMAC1 ns1__Envelope * SOAP_FMAC2 soap_instantiate_ns1__Envelope(struct soap*, int, const char*, const char*, size_t*);

inline ns1__Envelope * soap_new_ns1__Envelope(struct soap *soap, int n = -1) { return soap_instantiate_ns1__Envelope(soap, n, NULL, NULL, NULL); }

inline ns1__Envelope * soap_new_req_ns1__Envelope(
	struct soap *soap,
	const std::string& SOAP_ENV__Body_)
{	ns1__Envelope *_p = soap_new_ns1__Envelope(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__Envelope::SOAP_ENV__Body_ = SOAP_ENV__Body_;
	}
	return _p;
}

inline ns1__Envelope * soap_new_set_ns1__Envelope(
	struct soap *soap,
...
{	ns1__Envelope *_p = soap_new_ns1__Envelope(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__Envelope::SOAP_ENV__Header = SOAP_ENV__Header;
		_p->ns1__Envelope::SOAP_ENV__Body_ = SOAP_ENV__Body_;
		_p->ns1__Envelope::__anyAttribute = __anyAttribute;
	}
	return _p;
}

#ifndef soap_write_ns1__Envelope
#define soap_write_ns1__Envelope(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns1:Envelope", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 ns1__Envelope * SOAP_FMAC4 soap_get_ns1__Envelope(struct soap*, ns1__Envelope *, const char*, const char*);

#ifndef soap_read_ns1__Envelope
#define soap_read_ns1__Envelope(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__Envelope(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_default_SOAP_ENV__encodingStyle(soap, a) soap_default_std__string(soap, a)

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_SOAP_ENV__encodingStyle(struct soap*, const std::string *);

#define soap_SOAP_ENV__encodingStyle2s soap_std__string2s

SOAP_FMAC3 int SOAP_FMAC4 soap_out_SOAP_ENV__encodingStyle(struct soap*, const char*, int, const std::string*, const char*);

#define soap_s2SOAP_ENV__encodingStyle soap_s2std__string

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_in_SOAP_ENV__encodingStyle(struct soap*, const char*, std::string*, const char*);

#define soap_instantiate_SOAP_ENV__encodingStyle soap_instantiate_std__string


#define soap_new_SOAP_ENV__encodingStyle soap_new_std__string

SOAP_FMAC3 int SOAP_FMAC4 soap_put_SOAP_ENV__encodingStyle(struct soap*, const std::string *, const char*, const char*);

#ifndef soap_write_SOAP_ENV__encodingStyle
#define soap_write_SOAP_ENV__encodingStyle(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_SOAP_ENV__encodingStyle(soap, data), 0) || soap_put_SOAP_ENV__encodingStyle(soap, data, "SOAP-ENV:encodingStyle", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_get_SOAP_ENV__encodingStyle(struct soap*, std::string *, const char*, const char*);

#ifndef soap_read_SOAP_ENV__encodingStyle
#define soap_read_SOAP_ENV__encodingStyle(soap, data) ( ((data) ? (soap_default_SOAP_ENV__encodingStyle(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_SOAP_ENV__encodingStyle(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_default_SOAP_ENV__Body(soap, a) soap_default_std__string(soap, a)

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_SOAP_ENV__Body(struct soap*, const std::string *);

#define soap_SOAP_ENV__Body2s soap_std__string2s

SOAP_FMAC3 int SOAP_FMAC4 soap_out_SOAP_ENV__Body(struct soap*, const char*, int, const std::string*, const char*);

#define soap_s2SOAP_ENV__Body soap_s2std__string

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_in_SOAP_ENV__Body(struct soap*, const char*, std::string*, const char*);

#define soap_instantiate_SOAP_ENV__Body soap_instantiate_std__string


#define soap_new_SOAP_ENV__Body soap_new_std__string

SOAP_FMAC3 int SOAP_FMAC4 soap_put_SOAP_ENV__Body(struct soap*, const std::string *, const char*, const char*);

#ifndef soap_write_SOAP_ENV__Body
#define soap_write_SOAP_ENV__Body(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_SOAP_ENV__Body(soap, data), 0) || soap_put_SOAP_ENV__Body(soap, data, "SOAP-ENV:Body", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 std::string * SOAP_FMAC4 soap_get_SOAP_ENV__Body(struct soap*, std::string *, const char*, const char*);

#ifndef soap_read_SOAP_ENV__Body
#define soap_read_SOAP_ENV__Body(soap, data) ( ((data) ? (soap_default_SOAP_ENV__Body(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_SOAP_ENV__Body(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define SOAP_TYPE_PointerToxsd__anyURI (27)
#endif
...
#define SOAP_TYPE_PointerToSOAP_ENV__Header (13)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOf_XML (26)
#endif
